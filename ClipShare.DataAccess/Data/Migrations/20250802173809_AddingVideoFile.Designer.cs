...
namespace ClipShare.DataAccess.Data.Migrations
{
    ...
    [Migration("20250802173809_AddingVideoFile")]
    partial class AddingVideoFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClipShare.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClipShare.Entities.Comment", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClipShare.Entities.LikeDislike", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SubscribeAppUserId")
                        .HasColumnType("int");

                    b.Property<int?>("SubscribeChannelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubscribeAppUserId", "SubscribeChannelId");

                    b.ToTable("LikeDislike");
                });

            modelBuilder.Entity("ClipShare.Entities.Subscribe", b =>
                {
                    b.Property<int>("AppUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClipShare.Entities.Video", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClipShare.Entities.Channel", b =>
                {
                    b.HasOne("ClipShare.Entities.AppUser", "AppUser")
                        .WithOne("Channel")
                        .HasForeignKey("ClipShare.Entities.Channel", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ClipShare.Entities.LikeDislike", b =>
                {
                    ...
                    b.HasOne("ClipShare.Entities.Subscribe", null)
                        .WithMany("LikeDislikes")
                        .HasForeignKey("SubscribeAppUserId", "SubscribeChannelId");
            ...
            modelBuilder.Entity("ClipShare.Entities.Video", b =>
                {
                    b.HasOne("ClipShare.Entities.Category", "Category")
                        .WithMany("Videos")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ClipShare.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ClipShare.Entities.AppUser", null)
                        .WithMany()
